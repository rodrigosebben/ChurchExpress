object FormCadastroAssembleia: TFormCadastroAssembleia
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'FormCadastroAssembleia'
  ClientHeight = 501
  ClientWidth = 712
  Color = clWindow
  ...
  object Panel2: TPanel
    ...
    Height = 49
    Align = alTop
    Caption = 'CADASTRO DE ASSEMBL'#201'IA'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -21
  ...
  object Panel1: TPanel
    ...
    object DBEditData: TcxDBDateEdit
      Left = 16
      Top = 32
      DataBinding.DataField = 'Data'
      DataBinding.DataSource = DMCadastroAssembleia.DSAssembleia
      TabOrder = 0
      Width = 128
    end
    object DBCbxTipoAssembleia: TcxDBComboBox
      Left = 155
      Top = 32
      DataBinding.DataField = 'TipoAssembleia'
      DataBinding.DataSource = DMCadastroAssembleia.DSAssembleia
    ...
    object DBGridParticipantes: TDBGrid
      Left = 16
      Top = 76
      Width = 685
      Height = 309
      DataSource = DMCadastroAssembleia.DSAssembleiaMembros
      Enabled = False
      TabOrder = 3
