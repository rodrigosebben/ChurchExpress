object FormBuscaMembro: TFormBuscaMembro
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ...
  object QryBuscaMembro: TMyQuery
    ...
    SQL.Strings = (
        ...
        'Select m.CodMembro, m.NomeMembro, m.CodFamilia, f.Sobrenome, M.E' +
        'nvelope'
