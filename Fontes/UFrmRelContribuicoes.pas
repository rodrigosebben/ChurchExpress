...
type
  TFormRelContribuicoes = class(TForm)
    ...
    RdGrpSelecionaFamilia: TRadioGroup;
    RdGrpSelecionaMembro: TRadioGroup;
    ...
    procedure RdGrpSelecionaFamiliaClick(Sender: TObject);
    procedure RdGrpSelecionaMembroClick(Sender: TObject);
  private
  ...
  case CbxAtivo.ItemIndex of
    0: Begin
         ...
         Begin
           if EdtNomeFamilia.Tag<>0 then
           Begin
             QryRel.SQL.Add('Where c.CodFamilia = ' + IntToStr(EdtNomeFamilia.Tag));
             QryTotaisFamilia.SQL.Add('Where c.CodFamilia = ' + IntToStr(EdtNomeFamilia.Tag));
             QryTotaisMembros.SQL.Add('Where c.CodFamilia = ' + IntToStr(EdtNomeFamilia.Tag));
             where := True;
           End;
         End;

         if EdtNomeMembro.Tag<>0 then
         Begin
           if where=true then
           Begin
             QryRel.SQL.Add('and C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
             QryTotaisFamilia.SQL.Add('and C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
             QryTotaisMembros.SQL.Add('and C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
           End
           Else
           Begin
             QryRel.SQL.Add('Where C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
             QryTotaisFamilia.SQL.Add('Where C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
             QryTotaisMembros.SQL.Add('Where C.CodMembro = ' + IntToStr(EdtNomeMembro.Tag));
             where := True;
           End;
         End;
         ...
         Begin
           ...
           frxRpt.Variables.AddVariable('Geral','TipoContribuicao',QuotedStr(CBXTipoContribuicao.Text));
           frxRpt.Variables.AddVariable('Geral','Situacao',QuotedStr(CbxSituacao.Text));
           frxRpt.Variables.AddVariable('Geral','PeriodoInicial',QuotedStr(DtEdtDE.Text));
           frxRpt.Variables.AddVariable('Geral','PeriodoFinal',QuotedStr(DtEdtAte.Text));
           frxRpt.ShowReport;
         End;
       End;
    1: Begin
         ...
         frxRptInativos.Variables.AddVariable('Geral','TipoContribuicao',QuotedStr(CBXTipoContribuicao.Text));
         frxRptInativos.Variables.AddVariable('Geral','Situacao',QuotedStr(CbxSituacao.Text));
         frxRptInativos.Variables.AddVariable('Geral','PeriodoInicial',QuotedStr(DtEdtDE.Text));
         frxRptInativos.Variables.AddVariable('Geral','PeriodoFinal',QuotedStr(DtEdtAte.Text));
...
begin
  ...
  RdGrpSelecionaFamilia.ItemIndex := 0;
  RdGrpSelecionaFamilia.Left := 205;
  EdtNomeFamilia.Visible := False;
  SpdBtnBuscaFamilia.Visible := False;

  RdGrpSelecionaMembro.ItemIndex := 0;
  RdGrpSelecionaMembro.Left := 205;
  EdtNomeMembro.Visible := False;
  SpdBtnBuscaMembro.Visible := False;
...
procedure TFormRelContribuicoes.RdGrpSelecionaFamiliaClick(Sender: TObject);
begin

  case RdGrpSelecionaFamilia.ItemIndex of
    0:Begin
        RdGrpSelecionaFamilia.Left := 205;
        EdtNomeFamilia.Tag := 0;
        EdtNomeFamilia.Visible := False;
      ...
      End;
    1:Begin
        RdGrpSelecionaFamilia.Left := 14;
        EdtNomeFamilia.Visible := True;
        SpdBtnBuscaFamilia.Visible := True;
...
procedure TFormRelContribuicoes.RdGrpSelecionaMembroClick(Sender: TObject);
begin

  case RdGrpSelecionaMembro.ItemIndex of
    0:Begin
        RdGrpSelecionaMembro.Left := 205;
        EdtNomeMembro.Tag := 0;
        EdtNomeMembro.Visible := False;
      ...
      End;
    1:Begin
        RdGrpSelecionaMembro.Left := 14;
        EdtNomeMembro.Visible := True;
        SpdBtnBuscaMembro.Visible := True;
...
procedure TFormRelContribuicoes.SpdBtnBuscaFamiliaClick(Sender: TObject);
begin
...
begin
  ...
  if FormPrincipal.CodMembroGlobal>0 then
  Begin
    EdtNomeMembro.Tag := FormPrincipal.CodMembroGlobal;
    EdtNomeMembro.Text := FormPrincipal.NomeMembroGlobal + ' - ' + inttostr(FormPrincipal.CodMembroGlobal);
  End
  Else
    RdGrpSelecionaMembro.ItemIndex := 0;
