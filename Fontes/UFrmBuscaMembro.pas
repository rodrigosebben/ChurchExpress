...
uses UDMPrincipal, UFrmPrincipal, UFrmCadastroMembro;

procedure TFormBuscaMembro.BitBtn1Click(Sender: TObject);
begin
...
procedure TFormBuscaMembro.CbxBuscarPorSelect(Sender: TObject);
begin
...
procedure TFormBuscaMembro.CbxOrdenarPorSelect(Sender: TObject);
begin
...
procedure TFormBuscaMembro.CbxTipoBuscaSelect(Sender: TObject);
begin
...
procedure TFormBuscaMembro.CbxTipoMembroSelect(Sender: TObject);
begin
