object FormCadastroFalecido: TFormCadastroFalecido
  Left = 0
  Top = 0
  BorderStyle = bsNone
  ...
  object Panel1: TPanel
    ...
    object DBLkpCbxSepultura: TDBLookupComboBox
      Left = 8
      Top = 71
      Width = 145
      Height = 21
      DataField = 'CodSepultura'
      DataSource = DSFalecidos
      KeyField = 'CodSepultura'
      ListField = 'Numero'
      ListSource = DSLkpSepultura
      TabOrder = 4
    end
    ...
    object GrpBXDadosSepultura: TGroupBox
      Left = 8
      Top = 98
      Width = 661
      Height = 187
      Caption = '   Dados da Sepultura:   '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
      ...
      object Label12: TLabel
        ...
        FocusControl = DBEdtTipoSepultura
      end
      ...
      object Label14: TLabel
        ...
        Width = 175
        Height = 13
        Caption = 'Tipo de Taxa de Sepultamento:'
        FocusControl = DBEdtTipoTaxaSepultura
      end
      object Label15: TLabel
        ...
        Width = 107
        Height = 13
        Caption = 'Desapropriado em:'
        FocusControl = DBEdtDesapropriadoem
      end
      object Label16: TLabel
        ...
        Width = 115
        Height = 13
        Caption = 'Documento N'#250'mero:'
        FocusControl = DBEdtDocumentoNumero
      end
      ...
      object DBEdtTipoSepultura: TDBEdit
        Left = 382
        Top = 32
        Width = 150
        Height = 21
        Color = clInfoBk
        DataField = 'NomeTipoSepultura'
        DataSource = DSLkpSepultura
        Enabled = False
        ReadOnly = True
        TabOrder = 3
      end
      object DBEdtSepultura: TDBEdit
        Left = 537
        Top = 32
        Width = 116
        Height = 21
      ...
      object DBEdtTipoTaxaSepultura: TDBEdit
        Left = 12
        Top = 72
        Width = 200
        Height = 21
      ...
      object DBEdtDesapropriadoem: TDBEdit
        Left = 218
        Top = 72
        Width = 115
        Height = 21
      ...
      object DBEdtDocumentoNumero: TDBEdit
        Left = 339
        Top = 72
        Width = 150
        Height = 21
    ...
    object GrpBxResponsavel: TGroupBox
      ...
      object DBEdtResponsavel: TcxDBTextEdit
        Left = 8
        Top = 32
        DataBinding.DataField = 'NomeResponsavelSepultura'
        DataBinding.DataSource = DSLkpSepultura
        Enabled = False
      ...
      object DBEdtTelefone: TcxDBTextEdit
        Left = 8
        Top = 112
      ...
      object DBEdtCelular: TcxDBTextEdit
        Left = 135
        Top = 112
  ...
  object QryFalecidos: TMyQuery
    ...
    SQL.Strings = (
      'SELECT f.*,'
      '       S.CodResponsavelSepultura,S.Numero,'
      '       RS.NomeResponsavelSepultura'
      
        'FROM falecidossepultura f left join Sepulturas S on F.CodSepultu' +
        'ra = S.CodSepultura'
      
        '                          left Join ResponsavelSepultura RS on S' +
        '.CodResponsavelSepultura = RS.CodResponsavelSepultura')
    Left = 480
    Top = 4
    ...
    object QryFalecidosCodResponsavelSepultura: TLargeintField
      FieldName = 'CodResponsavelSepultura'
    end
    object QryFalecidosNumero: TStringField
      FieldName = 'Numero'
      Size = 45
    end
    object QryFalecidosNomeResponsavelSepultura: TStringField
  ...
  object DSLkpSepultura: TDataSource
    DataSet = QryLkpSepultura
    Left = 120
    Top = 8
  end
  object QryLkpSepultura: TMyQuery
    SQLInsert.Strings = (
    ...
    SQL.Strings = (
        ...
        'SELECT S.CodSepultura,S.Fila,S.Lado,S.Numero,S.Sepultura,S.DataD' +
        'esapropriacao,S.numerodocumento,S.Motivos,'
    ...
    Left = 32
    Top = 8
    object QryLkpSepulturaFila: TStringField
      FieldName = 'Fila'
      Size = 45
    end
    object QryLkpSepulturaLado: TStringField
      FieldName = 'Lado'
      Size = 45
    end
    object QryLkpSepulturaNumero: TStringField
      FieldName = 'Numero'
      Size = 45
    end
    object QryLkpSepulturaSepultura: TStringField
      FieldName = 'Sepultura'
      Size = 45
    end
    object QryLkpSepulturaDataDesapropriacao: TDateTimeField
      FieldName = 'DataDesapropriacao'
    end
    object QryLkpSepulturanumerodocumento: TStringField
      FieldName = 'numerodocumento'
      Size = 50
    end
    object QryLkpSepulturaMotivos: TMemoField
      FieldName = 'Motivos'
      BlobType = ftMemo
    end
    object QryLkpSepulturaNomeTipoSepultura: TStringField
      FieldName = 'NomeTipoSepultura'
      Size = 200
    end
    object QryLkpSepulturaNomeTipoTaxaSepultura: TStringField
      FieldName = 'NomeTipoTaxaSepultura'
      Size = 200
    end
    object QryLkpSepulturaCodResponsavelSepultura: TLargeintField
      FieldName = 'CodResponsavelSepultura'
    end
    object QryLkpSepulturaNomeResponsavelSepultura: TStringField
      FieldName = 'NomeResponsavelSepultura'
      Size = 250
    end
    object QryLkpSepulturaEndereco: TStringField
      FieldName = 'Endereco'
      Size = 250
    end
    object QryLkpSepulturaCompl: TStringField
      FieldName = 'Compl'
      Size = 200
    end
    object QryLkpSepulturaBairro: TStringField
      FieldName = 'Bairro'
      Size = 200
    end
    object QryLkpSepulturaCidade: TStringField
      FieldName = 'Cidade'
      Size = 250
    end
    object QryLkpSepulturaTelefone: TStringField
      FieldName = 'Telefone'
      Size = 45
    end
    object QryLkpSepulturaCelular: TStringField
      FieldName = 'Celular'
      Size = 45
    end
    object QryLkpSepulturaEmail: TStringField
      FieldName = 'Email'
      Size = 250
    end
    object QryLkpSepulturaCodMembro: TLargeintField
      FieldName = 'CodMembro'
    end
    object QryLkpSepulturacep: TStringField
      FieldName = 'cep'
      FixedChar = True
      Size = 10
    end
    object QryLkpSepulturaCodSepultura: TLargeintField
      FieldName = 'CodSepultura'
    end
  end
end
