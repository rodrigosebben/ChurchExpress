...
begin
  ...
  Begin
    ShowMessage('O Campo Fila é obrigatório!');
    DBEdtFila.SetFocus;
  End
  Else
  Begin
    ...
    Begin
      ShowMessage('O Campo Lado é obrigatório!');
      DBEdtLado.SetFocus;
    End
    Else
    Begin
      ...
      Begin
        ShowMessage('O Campo número é obrigatório!');
      ...
      Begin
        ...
        Begin
          ...
          Begin
            ShowMessage('O Campo Responsável é obrigatório!');
          ...
          Begin
            ...
            Begin
              ShowMessage('O Campo tipo de taxa é obrigatório!');
            ...
            Begin
              ...
              Begin
                ShowMessage('O Campo sepultura é obrigatório!');
