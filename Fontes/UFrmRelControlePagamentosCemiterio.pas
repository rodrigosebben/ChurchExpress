...
uses
  ...
  MyAccess, frxDBSet, frxExportRTF, frxExportPDF, frxExportHTML, frxExportCSV, frxExportText, frxExportImage;
...
begin
  ...
  Begin
    if where=true then
    Begin
      QryRelCemiterio.SQL.Add('And FS.DataVencimento between ' + QuotedStr(FormatDateTime('yyyy-mm-dd',DtEdtDE.Date)) + ' and ' + QuotedStr(FormatDateTime('yyyy-mm-dd',DtEdtATE.Date)));
    End
    Else
    Begin
      QryRelCemiterio.SQL.Add('Where FS.DataVencimento between ' + QuotedStr(FormatDateTime('yyyy-mm-dd',DtEdtDE.Date)) + ' and ' + QuotedStr(FormatDateTime('yyyy-mm-dd',DtEdtATE.Date)));
      where := True;
    End;
  End;
