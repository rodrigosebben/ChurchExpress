object FormRelAniversariantes: TFormRelAniversariantes
  ...
  object Panel2: TPanel
    ...
    Height = 41
    Align = alTop
    Caption = 'RELAT'#211'RIO DE ANIVERSARIANTES'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -21
  ...
  object Panel1: TPanel
    ...
    object RdGrpData: TRadioGroup
      ...
      Width = 248
      Height = 57
      Caption = ' SELECIONE O PER'#205'ODO '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object ChkBxArquivoTexto: TCheckBox
      Left = 112
      Top = 110
      Width = 173
      Height = 17
    ...
    object CbxOrdenar: TComboBox
      ...
      ItemIndex = 0
      TabOrder = 5
      Text = 'DATA ANIVERS'#193'RIO'
      Items.Strings = (
        'DATA ANIVERS'#193'RIO'
        'NOME'
        'IDADE'
        'FAMILIA')
    end
    object MemoAniversarios: TMemo
      Left = 12
      Top = 179
      Width = 473
      Height = 183
  ...
  object QryRel: TMyQuery
    Connection = DMPrincipal.Conn
    SQL.Strings = (
      'SELECT CodMembro, M.codmembroantigo, F.CodFamilia, F.Sobrenome, '
      '       NomeMembro,'
      '       Telefone,'
      '       Celular,'
      '       Email,'
      '       DataNasc,'
        ...
        '       DATE_FORMAT(NOW( ),'#39'%Y'#39') - DATE_FORMAT(datanasc, '#39'%Y'#39') - ' +
        '(DATE_FORMAT(NOW( ),'#39'00-%m-%d'#39') < DATE_FORMAT(datanasc,'#39'00-%m-%d' +
        #39')) AS Idade'
    ...
    object QryRelDataNasc: TDateField
      FieldName = 'DataNasc'
      Origin = 'membros.DataNasc'
    end
    object QryRelIdade: TFloatField
      FieldName = 'Idade'
      Origin = 'Idade'
    end
  end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object DataInicio: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Periodo: [DataInicio] at'#233' [DataFim]         Ordenado por: [Ordem' +
              ']')
          ParentFont = False
          VAlign = vaCenter
        end
