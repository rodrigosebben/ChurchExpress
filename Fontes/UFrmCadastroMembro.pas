...
begin
  ...
  Begin
    ...
    Begin
      ...
      Begin
        ShowMessage('O Campo tipo de membro é obrigatório!');
        DBEdtNome.SetFocus;
      End
      Else
      Begin
...
begin
  ...
  Begin
    ...
    Begin
      ...
      if Application.MessageBox('Deseja Adicionar as informações de endereço, telefones e e-mail da Família neste cadastro','ATENÇÃO',Mb_YesNo) = mrYes then
      Begin
