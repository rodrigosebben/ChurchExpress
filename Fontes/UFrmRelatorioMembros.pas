...
begin
  ...
  Begin
    Showmessage('Nenhum registro encontrado para impressão. Verifique se o filtro foi aplicado corretamente:');
  ...
  Begin
    ...
    Begin
      {   FILTROS
          ...
          3 - NÃO CONTENDO
          4 - QUE INICIE COM
          5 - QUE NÃO INICIE COM
          6 - QUE TERMINE COM
          7 - QUE NÃO TERMINE COM
          8 - ENTRE O INTERVALO
          9 - NÃO ESTÁ ENTRE O INTERVALO
          10 - VAZIO
          11 - NÃO É VAZIO
      }
...
begin
  ...
  MyQryRelMembros1.SQL.Add('Order by ' + ConverteFiltro(CbxOrdenação.ItemIndex) + ' ' + CbxOrdem.Text);
