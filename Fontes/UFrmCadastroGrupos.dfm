object FormCadastroGrupos: TFormCadastroGrupos
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'FormCadastroGrupos'
  ClientHeight = 289
  ClientWidth = 453
  Color = clWindow
  ...
  object QryGrupos: TMyQuery
    SQLInsert.Strings = (
      'INSERT INTO grupos'
      '  (CodGrupo, NomeGrupo, Descricao)'
      'VALUES'
      '  (:CodGrupo, :NomeGrupo, :Descricao)')
    SQLDelete.Strings = (
      'DELETE FROM grupos'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CodGrupo = :CodGrupo, NomeGrupo = :NomeGrupo, Descricao = :Des' +
        'cricao'
      'WHERE'
      '  CodGrupo = :Old_CodGrupo')
    SQLRefresh.Strings = (
      'SELECT CodGrupo, NomeGrupo, Descricao FROM grupos'
      'WHERE'
      '  CodGrupo = :CodGrupo')
    SQLLock.Strings = (
      'SELECT * FROM grupos'
    ...
    Left = 403
    Top = 8
    object QryGruposCodGrupo: TLargeintField
      FieldName = 'CodGrupo'
    end
    object QryGruposNomeGrupo: TStringField
      FieldName = 'NomeGrupo'
      Size = 255
    end
    object QryGruposDescricao: TMemoField
      FieldName = 'Descricao'
      BlobType = ftMemo
    end
  end
