...
uses UFrmPrincipal, UDMPrincipal, UFrmCadastroSantaCeia, UFrmConsultaSantaCeiaVisitante;

procedure TFormConsultaSantaCeia.BitBtn1Click(Sender: TObject);
begin
  ...
  FormConsultaSantaCeiaVisitante.Show;
      ...
      case CbxOrdem.ItemIndex of
        0:Begin
            case CbxOrdenacao.ItemIndex of
              0: QrySantaCeia.SQL.Add(' order by F.Sobrenome, sca.codfamilia, m.NomeMembro, sca.ano');
              1: QrySantaCeia.SQL.Add(' order by m.NomeMembro, sca.ano');
              2: QrySantaCeia.SQL.Add(' order by sca.Ano,F.Sobrenome, sca.codfamilia, m.NomeMembro');
            end;
          End;
        1:Begin
            case CbxOrdenacao.ItemIndex of
              0: QrySantaCeia.SQL.Add(' order by F.Sobrenome, sca.codfamilia, m.NomeMembro, sca.ano desc');
              1: QrySantaCeia.SQL.Add(' order by m.NomeMembro, sca.ano desc');
  ...
  Begin
    ...
    Begin
      ...
      case CBxBusca.ItemIndex of
        0: QrySantaCeia.SQL.Add(' and F.Sobrenome like ' + QuotedStr(EdtBusca.Text + '%'));
        1: QrySantaCeia.SQL.Add(' and M.NomeMembro like ' + QuotedStr(EdtBusca.Text + '%'));
        2: QrySantaCeia.SQL.Add(' and sca.ano like ' + QuotedStr(EdtBusca.Text + '%'));
        3: QrySantaCeia.SQL.Add(' and sca.codfamilia like ' + QuotedStr(EdtBusca.Text + '%'));
      end;
      // Adiciona a ordenação
      case CbxOrdem.ItemIndex of
        0:Begin
