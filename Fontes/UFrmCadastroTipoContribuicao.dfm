object FormCadastroTipoContribuicao: TFormCadastroTipoContribuicao
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'FormCadastroTipoContribuicao'
  ClientHeight = 191
  ClientWidth = 453
  Color = clWindow
  ...
  object Panel2: TPanel
    ...
    Height = 49
    Align = alTop
    Caption = 'CADASTRO DE TIPO DE CONTRIBUI'#199#195'O'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -21
  ...
  object Panel1: TPanel
    ...
    object DBEdtTipoContribuicao: TDBEdit
      Left = 16
      Top = 36
      Width = 421
      Height = 24
  ...
  object DSTipoContribuicao: TDataSource
