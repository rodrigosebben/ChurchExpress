object FormCadastroDataEspecial: TFormCadastroDataEspecial
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'FormCadastroDataEspecial'
  ClientHeight = 184
  ClientWidth = 453
  Color = clWindow
  ...
  object Panel2: TPanel
    ...
    Height = 49
    Align = alTop
    Caption = 'CADASTRO DE DATAS ESPECIAIS'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -21
  ...
  object Panel1: TPanel
    ...
    object DBEdtDescDataesp: TDBEdit
      Left = 16
      Top = 36
      Width = 421
      Height = 24
      CharCase = ecUpperCase
      DataField = 'DescDataEsp'
