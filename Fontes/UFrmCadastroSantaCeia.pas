...
begin
  ...
  Begin
    ...
    Begin
      ShowMessage('O Campo Membro é obrigatório!');
    ...
    Begin
      ...
      Begin
        ShowMessage('O Campo ano é obrigatório!');
        DBEdtAno.SetFocus;
      End
      Else
      Begin
  ...
  Begin
    if QrySantaCeia.State= dsInsert then
    Begin
      if Application.MessageBox('Um registro com o mesmo membro e mesmo ano foi encontrado no banco de dados. Deseja acessar esse registro e atualizar as informações?','Confirmação',Mb_YesNo+ Mb_IconInformation + Mb_DefButton1)=mrYes then
      Begin
        QrySantaCeia.Cancel;
