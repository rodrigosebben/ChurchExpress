unit UFrmRelSantaCeiaVisitante;
...
type
  TFormRelSantaCeiaVisitante = class(TForm)
    Panel2: TPanel;
    Panel3: TPanel;
    BtnSalvar: TBitBtn;
    BtnCancelar: TBitBtn;
...
var
  FormRelSantaCeiaVisitante: TFormRelSantaCeiaVisitante;
...
procedure TFormRelSantaCeiaVisitante.BtnCancelarClick(Sender: TObject);
begin
...
procedure TFormRelSantaCeiaVisitante.BtnSalvarClick(Sender: TObject);
Var
  where:boolean;
begin
...
procedure TFormRelSantaCeiaVisitante.FormShow(Sender: TObject);
begin
...
procedure TFormRelSantaCeiaVisitante.RdGrpDataClick(Sender: TObject);
begin
