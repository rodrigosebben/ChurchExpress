...
type
  TDMRelPastoral = class(TDataModule)
    ...
    QueryVisitas: TMyQuery;
    QueryVisitasDataVisita: TDateField;
    QueryVisitasVisitante: TStringField;
    ...
    QueryMembroAntigo: TMyQuery;
    QueryMembroAntigocodmembroantigo: TLargeintField;
    QueryMembroAntigochefefamilia: TBooleanField;
    QueryContribuicoesCompl: TStringField;
    QueryMembrosAdicionaisCompl: TStringField;
    QuerySantaCeiaCompl: TStringField;
  private
