...
type
  TFormCadastroVisita = class(TForm)
    ...
    Label7: TLabel;
    DBLkpCBxMembroSelecionado: TDBLookupComboBox;
    QryVisitaCodMembroVisitado: TLargeintField;
    AtualizaFamilia: TMyCommand;
...
begin
  ...
  Begin
    ShowMessage('O Campo Data da Visita é obrigatório!');
  ...
  Begin
    ...
    Begin
      ...
      Begin
        ShowMessage('O Campo Assunto é obrigatório!');
      ...
      Begin
        ...
        Begin
          ShowMessage('O Campo Referencia é obrigatório!');
        ...
        Begin
          ...
          Begin
            ShowMessage('O Campo Família é obrigatório!');
            SpdBtnBuscaMembroClick(self);
          End
          Else
          Begin
            // atualiza campo de ultima visita no cadastro de familias automaticamente
            AtualizaFamilia.ParamByName('pDataVisita').AsDateTime := QryVisitaDataVisita.AsDateTime;
            AtualizaFamilia.ParamByName('pVisitante').Value := QryVisitaVisitante.Value;
            AtualizaFamilia.ParamByName('pCodFamilia').Value := QryVisitaCodFamilia.Value;
            AtualizaFamilia.Execute;
...
begin
  ...
  Begin
    ...
    QryLkpMembros.Open;
    EdtNomeFamilia.Text := QryVisitaFamilia.AsString + ' - ' + QryVisitaCodFamilia.AsString;
  End
  Else
    EdtNomeFamilia.Text := '';
